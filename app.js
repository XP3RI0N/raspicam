...
function savePicture() {
	...
	http.request(url, function (response) {
		...
		response.on('end', function () {
			var d        = new Date(),
				fileName = "raspicam_" + d.getFullYear() + ((d.getMonth() < 10) ? '0' + d.getMonth() : d.getMonth()) + ((d.getDate() < 10) ? '0' + d.getDate() : d.getDate()) + "_time" + ((d.getHours() < 10) ? '0' + d.getHours() : d.getHours()) + ((d.getMinutes() < 10) ? '0' + d.getMinutes() : d.getMinutes()) + ((d.getSeconds() < 10) ? '0' + d.getSeconds() : d.getSeconds()) + ".jpg";
